function RICMprocess()
% This is an earlier version of the image loader, designed to work with
% RICM data.
% It offers you the option to subtract a fixed background image from the
% loaded timeseries. This allows you to correct for reflections that
% interfere with RICM imaging.
